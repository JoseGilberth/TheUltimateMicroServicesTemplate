package micro.catalogos._config.swagger;
...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Template", "https://smart-develop.mx",
			"jose.gilberto.colin@outlook.com");

	@SuppressWarnings("rawtypes")
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Template", "Documentación del API del Template ",
			"1.0.0", "Url termino de servicio", DEFAULT_CONTACT, "Apache 2.0",
