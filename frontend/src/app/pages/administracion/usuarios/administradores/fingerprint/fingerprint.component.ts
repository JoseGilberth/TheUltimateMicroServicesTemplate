...
export class FingerAdministradoresPrintComponent {
  ...
  ngOnInit(): void {
    this.usuariosDTO.password = "";
    this.usuariosDTO.repetirPassword = "";
  ...
  */
  ...
  onLoad() {
    if (this.readerFingerPrint != null) {
      ...
      this.readerFingerPrint.sdk.webChannel.disconnect();
      this.seleccionEscaneo = "Se ha recargado el huellero, selecciona un dedo para continuar escanenado";
    }
