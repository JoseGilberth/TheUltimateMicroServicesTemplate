...
@Getter
@Setter
public class FingerPrintFmdMeniqueIzquierdo extends File implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FingerPrintFmdMeniqueIzquierdo other = (FingerPrintFmdMeniqueIzquierdo) obj;
		if (id == null) {
