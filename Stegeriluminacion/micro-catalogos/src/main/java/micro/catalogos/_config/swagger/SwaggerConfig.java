...
public class SwaggerConfig {
	...
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Micro-Catalogos",
			"Documentación de API del microservicio " + "Micro-Catalogos", "1.0.0", "Url termino de servicio",
