...
public class OauthAccessTokenController  {
	...
	public ResponseEntity<Respuesta<Page<OauthAccessTokenDTO>>> filtrar(Pageable pageable, @RequestBody FiltroOauthAccessTokenDTO filtroOauthAccessTokenDTO) { // size=10 page=1
		Respuesta<Page<OauthAccessTokenDTO>> respuesta = oauthAccessTokenService.filtrar(pageable, filtroOauthAccessTokenDTO);
	...
	@PostMapping(value = "/token", consumes = { MediaType.TEXT_PLAIN_VALUE }, produces = { MediaType.APPLICATION_JSON_UTF8_VALUE })
