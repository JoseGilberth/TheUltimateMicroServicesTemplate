...
public class SwaggerConfig {
	...
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Micro-Correos",
			"Documentación de API del microservicio " + "Micro-Correos", "1.0.0", "Url termino de servicio",
