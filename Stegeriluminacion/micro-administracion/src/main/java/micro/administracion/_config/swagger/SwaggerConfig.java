package micro.administracion._config.swagger;
...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Indra Company", "https://www.indracompany.com",
			"jgcolin@indracompany.mx");

	@SuppressWarnings("rawtypes")
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Micro-Administracion",
			"Documentación de API del microservicio " + "Micro-Administracion", "1.0.0", "Url termino de servicio",
	...
	private AuthorizationScope[] scopes() {
		AuthorizationScope[] scopesVar = { new AuthorizationScope("read", "Lectura"),
				new AuthorizationScope("write", "Escritura") };
		return scopesVar;
	}
	...
	private Predicate<String> securePaths() {
		...
		// List<String> paths =
		// EndPointsControllers.readAllEndpoints("micro.administracion.controllers");
